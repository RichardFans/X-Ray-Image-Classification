...
st.sidebar.markdown("---")
st.sidebar.markdown("If you liked this project and would like to read the code and see some of my other work, don't forget to ⭐the [repository](https://github.com/SauravMaheshkar/X-Ray-Image-Classification) and follow [me](https://github.com/SauravMaheshkar).")


st.header("Interactive Demo")
st.info("NOTE: This demo uses a quantized EfficientNetB0 model for running inference. The code used for training the model can be found in the [github repository](https://github.com/SauravMaheshkar/X-Ray-Image-Classification)")
## Input Fields
...
st.markdown("---")
st.markdown("If you liked this project and would like to read the code and see some of my other work, don't forget to ⭐the [repository](https://github.com/SauravMaheshkar/X-Ray-Image-Classification) and follow [me](https://github.com/SauravMaheshkar).")
